...
public class Appium10BrowserStackAndroid {
    @Test
    public void browserstackAndroid() throws MalformedURLException, InterruptedException {
        DesiredCapabilities caps = new DesiredCapabilities();

        // Set your access credentials
        caps.setCapability("browserstack.user", "serblentarslan_Rm2za0");
        caps.setCapability("browserstack.key", "BmgSNqD3BrpW7S1rKxKx");
